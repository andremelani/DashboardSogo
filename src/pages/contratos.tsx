...
const Contratos = () => {
  ...
  const onSubmit: SubmitHandler<IFormState> = async (data) => {
    ...
    if (
      formState.numContrato != "" &&
      formState.dataRegistro != "" &&
      formState.dataValidade != "" &&
      formState.nome != "" &&
      formState.sobrenome != "" &&
      formState.cpf != "" &&
      formState.cep != "" &&
  ...
  return (
    <>
      <Title text="Cadastrar Contrato" size="large" />
      <Form>
        <Input
